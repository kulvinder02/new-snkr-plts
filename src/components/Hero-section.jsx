...
import hero_red_shoes from '../assets/images/hro-red-shoes.png'
import hero_smalshoes1 from '../assets/images/hro-small-shoes1.png'
import hero_smalshoes2 from '../assets/images/hro-small-shoes2.png'
import hero_smalshoes3 from '../assets/images/hro-small-shoes3.png'
import hero_smalshoes4 from '../assets/images/hro-small-shoes4.png'
    ...
    <div>
      ...
      <div className="container">
        <div className="row mt-lg-5">
          <div className="col-12 col-xl-6 pe-lg-5">
            <div className="mt-4">
              <img
                src={hero_red_shoes}
                alt="red-shoes"
            ...
            <div className="d-flex justify-content-between mt-2 mt-lg-4">
              <img
                src={hero_smalshoes1}
                className="shoes-scale cursr-pointr"
              />
              <img
                src={hero_smalshoes2}
                alt="shoes"
          ...
          <div className="col-12 col-xl-6 mt-4">
            <div className="ml-section1">
              <h1 class="ff-popins fs-30 fw-600 clr-black mt-xl-5 text-start">
              ...
              <div className="d-flex justify-content-start mt-1">
                ...
                <p className="ff-popins fs-20 fw-400 para-op">
                  ( 5 Customer Review )
                </p>
              </div>
              <p
                className="clr-black ff-popins fs-20 fw-400 opcty-6 mb-xl-5 text-start"
              >
                Sed nec ultricies felis, vitae facilisis ipsum. Morbi
                 id turpis
                euismod, rhoncus 
                tortor quis, lobortis sapien. Sed imperdiet
                nulla in leo ullamcorper, in finibus elit porta . Sed eget
                congue neque, mattis finibus neque. In vel dolor ac augue
                pretium
              </p>
              <div
                className="d-flex align-items-center text-center pt-md-3 pt-xl-4 quantity justify-content-start"
              >
                <p className="fs-20 font-poppins fw-500 pt-2">Qty:</p>
                <form
                  id="myform"
                  method="POST"
                  className="quantity ms-4 input-count"
                  action="#"
                >
                  <input
                    type="button"
                    value="-"
                    className="qtyminus minus oprtr-sign oprtr-clr font-poppins fs-20"
                    field="quantity"
                  />
                  <input
                    type="text"
                    name="quantity"
                    value="1"
                    className="qty oprtr-clr font-poppins fs-20"
                  />
                  <input
                    type="button"
                    value="+"
                    className="qtyplus plus grey-color oprtr-clr font-poppins fs-20"
                    field="quantity"
                  />
                </form>
                <span
                  ><button className="btn-cart fs-20 font-poppins fw-500">
                    Add to Cart
                  </button></span
                >
              </div>
              <div
                className="d-flex align-items-center pt-2 pt-lg-3 justify-content-start"
              >
                <label for="" className="font-poppins fs-20 fw-500">Size: </label>
                <select
                  name=""
                  id=""
                  className="ms-3 pding-size-box ms-4 input-count"
                >
                  <option value="" className="font-poppins fs-20 oprtr-clrr">
                    S
                  </option>
                  <option value="" class="font-poppins fs-20 oprtr-clr">
                    M
                  </option>
                  <option value="" className="font-poppins fs-20 oprtr-clr">
                    L
                  </option>
                  <option value="" className="font-poppins fs-20 oprtr-clr">
                    XL
              ...
              <div className="d-flex align-items-center pt-3 justify-content-start">
                <h className="font-poppins fs-20 fw-500">Color: </h>
                <div className="d-flex ml-boxes">
                  <div className="color-box ml-clr cursr-pointr">
                    <div className="red"></div>
                  </div>
                  <div className="color-box cursr-pointr">
              ...
              <div
                className="d-flex mt-3 mt-lg-4 align-items-center justify-content-start"
              >
                <div className="d-flex hover-box align-items-center">
                  <svg
                    className="svg-mr"
                    width="24"
                    height="24"
                  ...
                  <a href="" class="ff-popins fs-16 fw-300 clr-black mb-unset"
                    >Compare</a
                  >
                  <h1></h1>
                </div>
                <div className="d-flex align-items-center hover-box">
                  <svg
                    className="svg-like svg-mr"
                    width="29"
                    height="29"
                    viewBox="0 0 29 29"
                    fill="none"
              ...
              <div className="line mt-2 mt-lg-5"></div>
              <div className="d-flex mt-2 mt-lg-4 justify-content-start">
