...
import slidered_shoes from '../assets/images/slider-red-shoes.png'
import slidegray_shoes from '../assets/images/slider-gray-img.png'
  ...
  return (
    <div>
      ...
      <div className="container">
        <h1 className="ff-popins fs-30 fw-600 clr-black pt-lg-5 text-start">
          RELATED PRODUCT
        </h1>
        <div className="row mt-4 mb-4">
          <div className="col-6 col-lg-3 d-flex justify-content-center slider-pd d-none d-sm-block">
            <div className="slider-box overflow-hidden">
              <div className="position-relative">
                <div
                  className="ff-popins fw-300 fs-14 offr-text d-flex justify-content-center"
                >
                  <p>-10% OFF</p>
                </div>
                <div
                  className="img-txt d-flex align-items-center justify-content-center"
                >
                  <h1 className="ff-popins fw-400 fs-14 mt-2">NEW</h1>
                </div>
                <img
                  src={slidered_shoes}
                  alt="#"
              ...
              <div className="p-3 d-flex justify-content-between mt-2">
                <div>
                  <h1 className="ff-popins fs-18 fw-500 slider-head">
                    Quickiins Mens Shoes
                  </h1>
                  <p className="ff-popins fs-18 fw-500 dolr-txt pt-2">
                    $90.00
                    <span className="ff-popins fs-18 fw-500 dolr-text2"
                      >$70.00</span
                    >
                  </p>
                  <span
          ...
          <div className=" col-3 d-flex justify-content-center slider-pd d-none d-lg-block">
            <div className="slider-box overflow-hidden">
              <div className="position-relative">
                <div
                  className="ff-popins fw-300 fs-14 offr-text d-flex justify-content-center"
          ...
          <div className="col-12 col-sm-6 col-lg-3 d-flex justify-content-center slider-pd">
            <div className="slider-box overflow-hidden">
              <div className="position-relative">
                <div
                  className="ff-popins fw-300 fs-14 offr-text d-flex justify-content-center"
        ...
        <div className="row mb-lg-4">
          ...
          <div className="col-12 col-lg-3">
            <div
              className="mt-lg-5 d-flex flex-nowrap justify-content-end align-items-center mb-3 mb-lg-5"
            >
              <button className="next-btn arrowleft slider-bttn m-1">
                <h1 className="ff-popins fw-600 fs-24 mb-unset">1</h1>
              </button>
              <button className="next-btn arrowright slider-bttn m-1">
                <h1 className="ff-popins fw-600 fs-24 mb-unset">2</h1>
              </button>
              <button className="next-btn arrowright slider-bttn m-1">
                <h1 className="ff-popins fw-600 fs-24 mb-unset">3</h1>
              </button>
              <button className="nxt-bttn ff-popins fs-16 fw-400 ms-3">
                Next 
              </button>
            </div>
          </div>
