...
function Last_section() {
  return (
    <div>
       <footer className="fttr-bg">
      <div className="container">
        <div className="row mb-3">
          <div className="col-12 col-xl-5">
            <div className="pt-3 p-xl-5">
              <div className="d-flex justify-content-start">
              <img src={logo}  className='logo'/>
              </div>
              <p className="ff-popins fs-16 fw-400 clr-white fttr-para text-start">
          ...
          <div className="col-12 col-xl-7">
            <div className="row mt-xl-5">
              <div
                className="col-6 col-md-3 d-flex justify-content-start text-start"
              >
                <ul className="mt-xl-5 mt-4 pt-xl-5">
                  <li className="ff-popins fs-18 fw-600 clr-white mb-lg-3">
                    CUSTOM LINKS
                  </li>
                  <li className="mb-lg-2">
                    <a
                      href=""
                      class="ff-popins fs-18 fw-400 clr-white opcty-6 fttr-links"
                      >Lorem ipsum</a
                    >
                  </li>
                  <li className="mb-lg-2">
                    <a
                      href=""
                      className="ff-popins fs-18 fw-400 clr-white opcty-6 fttr-links"
                      >Lorem ipsum</a
                    >
                  </li>
                </ul>
              ...
              >
                <ul className="mt-xl-5 mt-4 pt-xl-5">
                  <li class="ff-popins fs-18 fw-600 clr-white mb-lg-3">
                    PRODUCTS
                  </li>
                  <li className="mb-lg-2">
                    <a
              ...
              <div
                className="col-6 col-md-3 d-flex justify-content-start text-start mb-3 mb-sm-4 mb-lg-5"
              >
                <ul className="mt-xl-5 mt-4 pt-xl-5">
                  <li className="ff-popins fs-18 fw-600 clr-white mb-lg-3">
                    YOUR ACCOUNT
      ...
      <div className="fttr-copy d-flex justify-content-center align-items-center">
        <p className="ff-popins fs-18 fw-400 fttr-copyrghit">
